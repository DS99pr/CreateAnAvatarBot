...
async def avatarCommand(ctx: commands.Context, member: discord.Member = None): # for the explanation of "commands.Context" check the documentation discord.py, or go to my repository called "CreateAPrefixCommandBot"
